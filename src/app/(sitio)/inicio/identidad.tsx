...
export default function Identidad() {
  return (
      <div className="identidadini bg-indigo-300/50">
        <Pantalla
          title={
            <Title radius={2} text={'¿Quiénes Somos?'} color={'text-ld-violeta'} size={'text-4xl md:text-7xl'}/>
           }
          one={
...
const Imagenes = () => (
  <div className="mt-10 md:mt-0">
    <Image src="/img/PersoIdentidad.webp" alt="Personaje1" width={735} height={938} />
  </div>
)
