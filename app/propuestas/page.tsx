...
export default function Page() {
    return <div className="my-20 px-20">
        ...
        <div className="flex flex-col items-center rounded-xl pt-10">
            ...
            <div className="grid grid-cols-3 gap-4 m-20">
                <div>
                    ...
                    <p data-aos="fade-left" data-aos-duration="2000" data-aos-delay="100" className="bg-slate-200 h-full p-4 rounded-xl items-center justify-center">
                ...
                <p data-aos="fade-left" data-aos-duration="2000" data-aos-delay="200" className="bg-slate-200 p-4 h-full rounded-xl items-center ">
                    <span className="circle"></span> 
                ...
                <p data-aos="fade-left" data-aos-duration="2000" data-aos-delay="300" className="bg-slate-200 h-full p-4 rounded-xl">
        ...
        <div className="flex flex-col items-center">
            ...
            <Link className="custom-btn btn-15" href="#tecnologias"> Explorar tecnologías</Link>
        </div>
