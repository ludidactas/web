...
const HeroMobile = ({ className }: HeroProps) => {
    ...
    <div data-aos-duration="1000" className={className} >
        ...
        <div className={`${Jersey.className} flex-col items-center flex gap-2 p-4 bg-white border-2 border-black border-dashed rounded-xl`}>
                    ...
                    <p className="pludi">Convocamos a personas interesadas en <span className="font-bold">practicar</span> el rol docente/didáctico/pedagógico y dispuestas a ocupar también el
                        de aprendientes.</p>
                    <h3 className="h3ludi bg-yellow-100 border-4 border-dashed border-black rounded-xl">¡Si estás interesadx, accedé a la info completa y escribinos!</h3>
    ...
    return (
        <>
            <div className="heroini block md:hidden">
                <HeroMobile className="heroini flex flex-col items-center h-[100vh] border-solid border-2 border-black rounded-xl p-4 bg-gradient-to-r from-cyan-500/50 to-blue-500/50" />
            </div>
