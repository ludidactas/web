...
export default function PanelConfigSala({ children }: PropsWithChildren) {
  ...
  const { lista: listaPermitidos, nombres, setNombre: guardarNombre } = storePermitidos()
                        ...
                        <div className="flex w-full">
                          ...
                          <div className="flex flex-col gap-1 flex-1 rounded p-2 max-h-56">
                            ...
                            <div className="flex gap-2 mt-1 justify-center">
                              <button
                                className={`px-3 py-1 text-sm rounded-full transition-colors ${inputDni.trim()
                          ...
                          {/* Lista de permitidxs */}
                          <div className='flex flex-col rounded items-center max-h-50'>
                            ...
                            <div className='flex gap-2 my-2'>
                              ...
                              <button
                                className={`px-3 py-1 text-sm rounded-full transition-colors ${listaPermitidos.length > 0
