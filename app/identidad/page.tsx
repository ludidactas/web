      ...
      <div className="text-center">
        ...
        <div className="mt-20">
          ...
          <div className="flex flex-col text-center  mx-20 p-2">
            <p className="text-[1.3rem] m-10 p-10 bg-slate-200 rounded-xl mb-10">
              Uno de los desafíos que se nos presenta a los educadores en la actualidad es la creciente disociación
              entre diferentes áreas de la enseñanza en todos los niveles educativos. Sumado a esto, actualmente
              experienciamos una progresiva influencia de la tecnología en todas las áreas del conocimiento y esferas
              sociales.{' '}
            </p>
        ...
        <div className="flex flex-col mx-20 gap-20">
          <p className="text-[1.3rem] m-10 p-10 bg-sky-200 rounded-xl">
            Entendemos{' '}
            <span className="text-[#46BFD7] text-2xl">el juego como germen de la educación y de la creatividad</span>,
            que ocurre en la naturaleza espontánea y consistentemente, con un rol didáctico: cada especie juega como le
            ...
            performarce. El juego nos facilita aprender independiendo de las formas. Nos muestra horizontes, que
            reclaman caminos.
          </p>
