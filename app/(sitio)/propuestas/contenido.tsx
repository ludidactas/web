    ...
    return (<>
        <div
            ...
            <div className="flex flex-col rounded-xl bg-white/90 h-full">
                ...
                <div className='flex flex-col items-center text-xl h-[64px] leading-[44px] '>
                    {btn}
                </div>
        ...
        <div className="flex flex-col items-center">
            <div className="flex flex-col text-center items-center p-4 max-w-[1480px] lg:px-24 text-sm lg:text-2xl mb-20 bg-white/50">
                ...
                <p className="m-4">
                    ...
                    seminarios directamente se dispensa la formación técnica y en el blog se publicamos textos sobre pedagogía y
                    enseñanza al público general.
                </p>
                <Link className='md:text-5xl text-[#8B5BF6] hover:underline' href="https://instagram.com/ludidactas">¡Consultanos!</Link>
            </div>
            ...
            <div className=' bg-indigo-500/30 w-full gap-2 mx-10'>
                ...
                <div className='flex flex-col md:grid md:grid-cols-3'>
                    ...
                    <Lineas
                        ...
                        btn={
                            <BtnSketchyGif href={''} disabled texto='Próximamente...' />
                    ...
                    <Lineas
                        ...
                        btn={
                            <BtnSketchyGif href="/convocatoria" texto='Convocatoria' />
                    ...
                    <Lineas
                        ...
                        btn={
                            <BtnSketchyGif href="https://ludidactas.medium.com/" texto='Ver Blog' />
                        }
    ...
    return (
        <TooltipProvider delayDuration={0}>
            ...
            <Tooltip open={open} onOpenChange={setOpen}>
                <TooltipTrigger className='p-4 hover:outline-8 hover:outline-dashed hover:outline-[#00B0D2]/50 rounded-xl' onClick={() => setOpen(!open)}>
