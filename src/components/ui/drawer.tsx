...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      {...props}
    >
      <div className="mx-auto mt-4 h-2 w-[100px] shrink-0 rounded-full bg-muted group-data-[vaul-drawer-direction=left]:hidden group-data-[vaul-drawer-direction=right]:hidden" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
))
