...
export function BotonLink({
  ...
  return (
    <Link href={url}>
      <Boton classNames={{ root: "flex items-center justify-center w-52 md:w-[350px] h-20 md:h-32 py-4 hover:scale-110" }}>
        <div className="flex gap-6 items-center pb-2 group cursor-pointer">
          <div className="flex">
            <span className="text-sm md:text-2xl p-4 text-center font-bold text-white [text-shadow:_-1px_-1px_0_#000,_1px_-1px_0_#000,_-1px_1px_0_#000,_1px_1px_0_#000] ">
              {titulo}
            </span>
          </div>
        </div>
