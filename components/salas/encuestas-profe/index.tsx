...
//       <Status />
//       <div className="animate-aparecer h-fit flex flex-col md:flex-row md:py-2 md:gap-2 justify-center">
//         {/* Preguntas Formulario*/}
//         <div className="flex flex-col bg-white  md:rounded-xl" tabIndex={0}>
