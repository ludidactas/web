...
export default function Identidad() {
  return (
    <div className="identidadini bg-indigo-300/50">
      <Pantalla
        title={<Title radius={2} text={'¿Quiénes Somos?'} color={'text-[#8345FD]'} size={'text-4xl md:text-7xl'} />}
        one={
          <div className="flex flex-col gap-2 md:gap-8 md:max-w-[35vw] text-sm md:text-[1.1em]">
            <p>
        ...
        two={<Imagenes />}
        btn={<BotonLink titulo={'Más sobre el proyecto'} url={'/identidad'} />}
