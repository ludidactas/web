...
const Formatos = () => {
    return <div className="mt-20 mx-20">
        ...
        <div className="flex flex-col items-center rounded-xl pt-10">
            ...
            <div className="grid grid-cols-3 gap-4 m-20">
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000" data-aos-delay="100" className="bg-slate-200 h-full p-4 rounded-xl items-center justify-center">
                        <span className="circle"></span>
                        <p className="text-3xl text-center text-[#46BFD7] drop-shadow-lg m-4">Seminarios</p>
                        <p className="m-2">Son instancias de una o dos clases intensivas y largas en las que vemos de manera introductoria algún tema puntual.
                            Es ideal para almas autodidactas que pueden aprovechar una buena rampa de entrada a un tema que les evite el famoso "infierno de tutoriales".</p>
                    </div>
               
                <div data-aos="fade-left" data-aos-duration="2000" data-aos-delay="200" className="bg-slate-200 p-4 h-full rounded-xl items-center ">
                    <span className="circle"></span>
                    <p className="text-3xl text-center text-[#46BFD7] drop-shadow-lg m-4">Talleres</p>
                    <p className="m-2">Son instancias largas, recurrentes, orientadas alrededor de una línea de desarrollo de proyectos.
                        Es ideal para almas aplicadas, que disfruten el trabajo en equipo, y la buena cosecha que sigue a una buena siembra.</p>

                </div>
                <div data-aos="fade-left" data-aos-duration="2000" data-aos-delay="300" className="bg-slate-200 h-full p-4 rounded-xl">

                    <span className="circle"></span>
                    <p className="text-3xl text-center text-[#46BFD7] drop-shadow-lg m-4">Clases Particulares</p>
                    Son para vos si sabés lo querés y vas con toda en esa dirección, o si apreciás el fruto de un trabajo sostenido y preferís el mentoreo individual.
                </div>
            </div>
        </div>
    </div>
...
const Lineas = () => {
    return <div className="m-20">
        ...
        <h1 data-aos="fade-left" className={`${Jersey.className} m-10 pt-10 drop-shadow-lg text-7xl`}>Líneas de contenido</h1>
        <p> Hemos desarrollado un esquema que nos permite ofrecer oportunidades de formación para todos los niveles de aprendizaje, en módulos cortos y autoconclusivos.
...
const Tecnologias = () => {
    return <div><h1 className="p-8 mx-4 text-3xl rounded-xl bg-slate-300/50">
        Todas las propuestas se encuentran dirigidas tanto a personas pertenecientes al ámbito educativo,
        como a un público general, que busquen formarse en cada una de las líneas de contenido y de
        las <span className="font-bold">tecnologías asociadas a ellas.</span>
    </h1>

        <div className="text-center">

            <h1 data-aos="fade-left" className={`${Jersey.className} m-10 pt-10 drop-shadow-lg text-7xl`}>Tecnologías</h1>
